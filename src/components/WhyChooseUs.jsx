      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="md:hidden">
          <div className="mb-8">
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`alt-${index}`} className="text-white font-medium text-sm pl-4 border-l-2 border-[#C57B85]/50 py-1">
                  {item.alternative}
                </li>
              ))}
            </ul>
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`lim-${index}`} className="text-neutral-300 text-sm leading-relaxed pl-4 border-l-2 border-[#C57B85]/50 py-1">
                  {item.limitation}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`adv-${index}`} className="text-white font-medium text-sm leading-relaxed pl-4 border-l-2 border-[#C57B85] py-1">
                  {item.advantage}
                </li>
              ))}
            </ul>
        ...
        <div className="hidden md:block lg:hidden">
          <div className="mb-8">
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`alt-${index}`} className="text-white font-medium text-base pl-4 border-l-2 border-[#C57B85]/50 py-1">
                  {item.alternative}
                </li>
              ))}
            </ul>
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`lim-${index}`} className="text-neutral-300 text-base leading-relaxed pl-4 border-l-2 border-[#C57B85]/50 py-1">
                  {item.limitation}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {comparisons.map((item, index) => (
                <li key={`adv-${index}`} className="text-white font-medium text-base leading-relaxed pl-4 border-l-2 border-[#C57B85] py-1">
                  {item.advantage}
                </li>
              ))}
            </ul>
        ...
        <div className="hidden lg:block overflow-x-auto">
          <div className="min-w-full">
            <div className="grid grid-cols-12 gap-3 mb-3">
              <div className="col-span-3 border border-[#C57B85]/50 rounded-2xl py-4 px-6 text-center text-white bg-neutral-950 text-sm font-semibold tracking-wider uppercase">
                Alternative
              </div>
              <div className="col-span-4 border border-[#C57B85]/50 rounded-2xl py-4 px-6 text-center text-white bg-neutral-950 text-sm font-semibold tracking-wider uppercase">
                The limitation
              </div>
              <div className="col-span-5 border border-[#C57B85] rounded-2xl py-4 px-6 text-center text-white bg-[#C57B85]/10 text-sm font-semibold tracking-wider uppercase">
            ...
            {comparisons.map((item, index) => (
              <div key={index} className="grid grid-cols-12 gap-3 mb-3">
                ...
                <div className="col-span-3 border border-[#C57B85]/50 rounded-2xl p-6 bg-neutral-950/60 text-white font-medium text-base flex items-center min-h-[80px]">
                  {item.alternative}
                </div>
